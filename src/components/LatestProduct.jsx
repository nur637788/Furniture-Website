                ...
                <div className="max-w-[100%] max-h-[100%]">
                    <div data-aos='zoom-in' className='hero w-full h-full py-20'
                        ...
                        <div className='px-8 space-y-4'>
                            ...
                            <button onClick={() => navigate('/shopnow')} className='px-4 py-1 text-white bg-[#092B42] rounded-md hover:bg-[#527A9A]  hover:scale-95 duration-300'>Shop Now</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-[100%] max-h-[100%] text-white">
                    <div data-aos='zoom-in' className='hero w-full h-[100%] py-20'
                        ...
                        <div className='px-s space-y-4'>
                            ...
                            <button onClick={() => navigate('/shopnow')} className='px-4 py-1 text-black bg-white rounded-md hover:bg-[#527A9A]  hover:scale-95 duration-300'>Shop Now</button>
                        </div>
                    </div>
                </div>
            </div>
