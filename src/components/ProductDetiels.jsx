          ...
          <div data-aos='zoom-in' className="bg-blue-500 rounded-md py-5 px-5 mt-3">
            ...
            <div className="flex justify-between">
              <button onClick={() => dispatch(addToCart(product))}
                className=" px-3 py-2 rounded bg-red-500 hover:bg-red-700 hover:scale-95 duration-300 cursor-pointer">Add to Cart</button>
              <button onClick={() => navigate('/shopnow')} className=" bg-green-500 hover:bg-green-600 hover:scale-95 duration-300 text-white px-4 py-2 rounded cursor-pointer">Shop Now</button>
            </div>
          </div>
