...
export default function ProductDetails() {
  ...
  // তোমার products data — এখানেই রাখতে পারো বা বাইরে থেকে ইমপোর্ট করতে পারো
  const products = [
      {
      id:'1',
...
},
{
  ...
  if (!product) {
    return (
      <div className="text-center py-40 text-2xl font-bold">
        <span className="text-red-700">Product not found 😢</span>
      </div>
    );
  }
  ...
  return (
    <div>
    <section className="mx-5 text-white mt-20">
      <div data-aos='zoom-in' className="max-w-96 max-h-96 m-auto pt-5  rounded">
        <img src={product.image} alt={product.name}
        className="w-full h-full object-cover rounded shadow-2xl"/>
      </div>
 
        <div className="max-w-96 m-auto mt-5 p-2 bg-gray-500 rounded">
            <div className="flex justify-between text-xl">
                <p className="font-bold">ProductID: </p>
                <p>00{product.id}</p>
            </div><hr className="bg-gray-600" />
            ...
            <div className="flex justify-between text-xl">
                ...
                {/* 2 ta Button Add to Cart & Shop Now */}
         <div data-aos='zoom-in' className="bg-blue-500 rounded-md py-5 px-5 mt-3">
            <p className="text-2xl text-center text-white"><b>Price:</b> {product.price}</p> <hr className="pt-5" />
             <div className="flex justify-between">
                <button className=" px-3 py-1 rounded bg-gray-600 hover:bg-[#527A9A] hover:scale-95 duration-300">Add to Cart</button>

                <button onClick={()=>navigate('/shopnow')} className=" px-3 py-1 rounded bg-gray-600 hover:bg-[#527A9A] hover:scale-95 duration-300">Shop Now</button>
            </div>
        </div>
            {/* Product Description */}
        <p data-aos='zoom-in' className="font-light">
        <b className="text-xl font-bold">About This Product: </b> <br />
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum id incidunt nostrum nam nobis adipisci maxime, vitae iure porro, odio qui alias blanditiis distinctio, minima tenetur accusantium. Impedit repellendus, ratione enim iusto doloribus consequuntur ab cumque in dolore itaque blanditiis debitis dicta expedita neque quo corrupti harum doloremque suscipit a ut nesciunt facere natus ullam aliquam? At totam aliquid voluptatem? Expedita ullam nisi ipsam officiis ipsa laboriosam quaerat, labore voluptate eligendi suscipit ad dolorum quod molestias quas aspernatur mollitia provident vitae totam iste incidunt.
        </p>
        ...
        {/* Customer Review */}
            ...
            {/* Customer-1 */}
        <div role="alert" className="bg-gray-800 rounded-md p-3 mt-1">
          <div className="flex items-center gap-2">
           <img className="w-10 h-10 rounded-full bg-white" src="/images/man.jpg" alt="Customer image-1" />
            <div className="leading-3">
              <h2 className="font-semibold">Ahmod Bin</h2>
        ...
        <div role="alert" className="bg-gray-800 rounded-md p-3 mt-1">
          <div className="flex items-center gap-2">
           <img className="w-10 h-10 rounded-full bg-white" src="/images/man1.jpg" alt="Customer imag-2" />
            <div className="leading-3">
              <h2 className="font-semibold">Johan Deo</h2>
        ...
        <div role="alert" className="bg-gray-800 rounded-md p-3 mt-1">
          <div className="flex items-center gap-2">
           <img className="w-10 h-10 rounded-full bg-white" src="/images/man2.jpg" alt="Customer image-3" />
            <div className="leading-3">
              <h2 className="font-semibold">Javid Well</h2>
      ...
      <Link to="/product"
        className="inline-block mt-6 bg-gray-300 text-black px-4 py-2 rounded hover:bg-gray-600 transition-all duration-300">
        ← Back to Products
      </Link>
    </section>
