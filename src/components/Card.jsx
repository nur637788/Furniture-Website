  ...
  return (
    ...
    <div className='p-2 space-y-2 text-center'>
          ...
          <p className="tetext-center"> <b>Price:</b> {price}</p>
                ...
                {/* button design */}
        <Link to={`/product/${id}`}  
          className="w-full h-10 flex items-center justify-center rounded-md shadow-2xl text-white bg-gray-600 hover:bg-[#527A9A]  hover:scale-95 duration-300">More Details</Link>
    </div>
    </article>
  );
}
